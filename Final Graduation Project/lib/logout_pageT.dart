...
import 'therapist_page.dart'; // تأكد من أن هذه الصفحة هي الصفحة الخاصة بالـ Therapist

class LogoutPageT extends StatelessWidget {
  const LogoutPageT({super.key});
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'By logging out, you will no longer have access to the app until you sign in again as a therapist.',
                        style: TextStyle(
                          fontSize: 16,
                          ...
                          ElevatedButton(
                            onPressed: () {
                              ...
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => PatientPage(), // العودة للصفحة الرئيسية الخاصة بالـ Therapist
                                ),
                              );
                            },
