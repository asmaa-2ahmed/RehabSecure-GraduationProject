import 'package:account_gp/privacy_pageT.dart';
import 'package:flutter/material.dart';
import 'profile_pageP.dart'; // تأكد من استيراد الصفحات المناسبة
import 'passwordmanager_pageP.dart';
import 'logout_pageT.dart';

class SettingsPageT extends StatelessWidget {
  const SettingsPageT({super.key});
                        ...
                        _buildSettingOption(
                          ...
                          onTap: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const PrivacyPageT(),
                              ),
                            );
                          },
                        ),
                        ...
                        _buildSettingOption(
                          ...
                          onTap: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const LogoutPageT(),
                              ),
                            );
                          },
                        ),
