import 'package:account_gp/settings_pageP.dart';
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image:
                AssetImage('images/background5.png'), // الخلفية من الـ assets
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      // قم بتحديد صفحة الإعدادات الخاصة بك هنا
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                SettingsPageP()), // تأكد من استبدال SettingsPage بصفحتك الخاصة
                      );
                    },
                  ),
                ],
            ...
            Center(
              child: Image.asset(
                'images/imge3.png', // الصورة من الـ assets
                height: 300,
                width: 400,
                fit: BoxFit.cover,
              ),
