...
class PrivacyPageP extends StatelessWidget {
  const PrivacyPageP({super.key});
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'We may collect personal information such as your name, email address, and other details when you use our services. This information is used solely for the purpose of improving your experience with the app.',
                            style: TextStyle(
                              fontSize: 16,
                              color: Colors.black87,
                            ),
